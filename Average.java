...
public class Average {
    ...
    //method to get the score from average
    static long aveGetScore() {
		return score;
	}
    
    //method to get the wpm from average
    static long aveGetWPM() {
    	return wpm;
    }
    
    //method to get the accuracy from average
    static long aveGetAccuracy() {
		return accuracy;
	}
	...
	static void Average() {
		...
		p.add("Sampaloc Apalit Pampanga");
		p.add("Sige lang kapatid");
		p.add("kenchana tengneng nengneng");
		p.add("Sa bawat sandali");
		p.add("Teng neng neng");
        ...
        System.out.println(CYAN + "             AVERAGE LEVEL GAME             " + RESET);
        System.out.println(CYAN + "============================================" + RESET);
